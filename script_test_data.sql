...
INSERT INTO REZEPT(REZEPTID, REZEPTNAME, ZUTATENNR, VEGETARISCH, VEGAN, NueSSE, FRUTARISCH, LOWCARB) VALueS (6300, 'Kartoffelsuppe', 1, true, true, false, false, true);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALueS (6300, 1001, 5);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALueS (6300, 1002, 3);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALueS (6300, 1006, 2);

INSERT INTO REZEPTZUTAT(REZEPTNR, ZUTATENNR, MENGE) VALueS (6300, 1004, 3);
