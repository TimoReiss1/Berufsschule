...
CREATE TABLE ALLERGEN(
    ALLERGENNR      SERIAL PRIMARY KEY NOT NULL,
...
CREATE TABLE REZEPT_ALLERGEN(
    ...
    PRIMARY KEY     (REZEPTNR, ALLERGENNR)
);
...
ALTER TABLE REZEPT_ALLERGEN ADD FOREIGN KEY (REZEPTNR) REFERENCES REZEPT (REZEPTNR);
ALTER TABLE REZEPT_ALLERGEN ADD FOREIGN KEY (ALLERGENNR) REFERENCES ALLERGEN (ALLERGENNR);
